	...
	<>
		...
		<label htmlFor="numberIn">Input modifier:</label>
		<input type='number' className='numberIn' onChange={handleNumberInputChange} name='numberIn' min="0"></input>
		<button type="button" className="counter" onClick={fetchRoll}>Roll D20</button>
		{roll !== null && <h2>Rolled: {roll}</h2>}
		{roll !== null && <h2>Modifier: {rollMod}</h2>}
		{roll !== null && <h2>Total: {totalRoll}</h2>}
		</section>
